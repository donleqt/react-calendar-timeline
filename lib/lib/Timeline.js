...
var _Ranges = require('./ranges/Ranges');
...
var ReactCalendarTimeline = function (_Component) {
  ...
  _createClass(ReactCalendarTimeline, [{
    ...
    key: 'ranges',
    value: function ranges(canvasTimeStart, canvasTimeEnd, canvasWidth, height, headerHeight) {
      return _react2.default.createElement(_Ranges2.default, { canvasTimeStart: canvasTimeStart,
        canvasTimeEnd: canvasTimeEnd,
        canvasWidth: canvasWidth,
        height: height,
...
ReactCalendarTimeline.propTypes = {
  ...
  ranges: _propTypes2.default.array,
